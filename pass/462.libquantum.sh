...
cd ..
cd Test/spec/2006/462.libquantum/
make
cd ../../../../
opt -load instrument/libPTAuthpass.so -ptauth < Test/spec/2006/462.libquantum/libquantum-final.bc > instrumented.bc
...
#llvm-link Test/spec/2006/462.libquantum/libquantum-final.bc  instrument/ptauth-rtlib.bc instrument/utils.bc  instrument/pacinst.bc -o extfunc_optimized.bc
