...
cd ..
cd Test/spec/2006/433.milc/
make
cd ../../../../
opt -load instrument/libPTAuthpass.so -ptauth < Test/spec/2006/433.milc/milc-final.bc > instrumented.bc
...
#llvm-link Test/spec/2006/433.milc/milc-final.bc -o extfunc_optimized.bc
