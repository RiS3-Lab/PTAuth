...
cd ..
cd Test/spec/2006/458.sjeng/
make
cd ../../../../
opt -load instrument/libPTAuthpass.so -ptauth < Test/spec/2006/458.sjeng/sjeng-final.bc > instrumented.bc
...
#llvm-link Test/spec/2006/458.sjeng/sjeng-final.bc -o extfunc_optimized.bc
