...
cd ..
cd Test/spec/2006/464.h264ref/
make
cd ../../../../
opt -load instrument/libPTAuthpass.so -ptauth < Test/spec/2006/464.h264ref/h264ref-final.bc > instrumented.bc
...
#llvm-link Test/spec/2006/464.h264ref/h264ref-final.bc -o extfunc_optimized.bc
...
#clang -mllvm -inline-threshold=100000 --target=aarch64-linux-gnu -fsanitize=undefined  -fno-omit-frame-pointer -march=armv8.3-a extfunc_optimized.bc -o stest.arm.elf -lm  -fno-stack-protector  -g3
