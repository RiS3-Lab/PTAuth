...
cd ..
cd Test/spec/2006/470.lbm/
make
cd ../../../../
opt -load instrument/libPTAuthpass.so -ptauth < Test/spec/2006/470.lbm/lbm-final.bc > instrumented.bc
...
#llvm-link Test/spec/2006/470.lbm/lbm-final.bc -o extfunc_optimized.bc
