...
cd ..
cd Test/spec/2006/401.bzip2/
make
cd ../../../../
opt -load instrument/libPTAuthpass.so -ptauth < Test/spec/2006/401.bzip2/bzip2-final.bc > instrumented.bc
...
#llvm-link Test/spec/2006/401.bzip2/bzip2-final.bc  -o extfunc_optimized.bc
