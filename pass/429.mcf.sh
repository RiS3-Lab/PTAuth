...
cd ..
cd Test/spec/2006/429.mcf/
make 
cd ../../../../
opt -load instrument/libPTAuthpass.so -ptauth < Test/spec/2006/429.mcf/mcf-final.bc > instrumented.bc
...
#llvm-link Test/spec/2006/429.mcf/mcf-final.bc -o extfunc_optimized.bc
