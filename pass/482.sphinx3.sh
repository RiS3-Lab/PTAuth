...
cd ..
cd Test/spec/2006/482.sphinx3/
make
cd ../../../../
opt -load instrument/libPTAuthpass.so -ptauth < Test/spec/2006/482.sphinx3/sphinx3-final.bc > instrumented.bc
...
llvm-link Test/spec/2006/482.sphinx3/sphinx3-final.bc -o extfunc_optimized.bc
